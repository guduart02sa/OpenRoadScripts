export DESIGN_NAME            = ibex_id_stage
export DESIGN_NICKNAME        = ibex_ibex_id_stage
export PLATFORM               = sky130hd


# Only include the ALU Verilog; other modules will be synthesized separately.
export VERILOG_FILES          = $(DESIGN_HOME)/src/ibex/ibex_id_stage.v \
$(DESIGN_HOME)/src/ibex/ibex_controller.v\
$(DESIGN_HOME)/src/ibex/ibex_decoder.v
export SDC_FILE               = $(DESIGN_HOME)/sky130hd/ibex/$(DESIGN_NAME)/constraint.sdc


export CORE_UTILIZATION = 40
export CORE_ASPECT_RATIO = 6 
...
export PLACE_PINS_ARGS = -min_distance 1.5
