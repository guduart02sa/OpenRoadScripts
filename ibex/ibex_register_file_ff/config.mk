export DESIGN_NAME            = ibex_register_file_ff
export DESIGN_NICKNAME        = ibex_ibex_register_file_ff
export PLATFORM               = sky130hd


# Only include the ALU Verilog; other modules will be synthesized separately.
export VERILOG_FILES          = $(DESIGN_HOME)/src/ibex/ibex_register_file_ff.v
