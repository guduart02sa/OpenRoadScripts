export DESIGN_NAME            = ibex_if_stage
export DESIGN_NICKNAME        = ibex_ibex_if_stage
export PLATFORM               = sky130hd


# Only include the ALU Verilog; other modules will be synthesized separately.
export VERILOG_FILES          = $(DESIGN_HOME)/src/ibex/ibex_if_stage.v \
$(DESIGN_HOME)/src/ibex/ibex_prefetch_buffer.v \
$(DESIGN_HOME)/src/ibex/ibex_compressed_decoder.v \
$(DESIGN_HOME)/src/ibex/ibex_fetch_fifo.v 
