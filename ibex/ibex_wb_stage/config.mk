export DESIGN_NAME            = ibex_wb_stage
export DESIGN_NICKNAME        = ibex_ibex_wb_stage
export PLATFORM               = sky130hd


# Only include the ALU Verilog; other modules will be synthesized separately.
export VERILOG_FILES          = $(DESIGN_HOME)/src/ibex/ibex_wb_stage.v
...
export PLACE_PINS_ARGS = -min_distance 1.8
